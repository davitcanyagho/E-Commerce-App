                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="price" id="price" class="form-control" placeholder="Harga" value="{{ $product->price }}">
                                        <p class="error"></p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select name="is_featured" id="is_featured" class="form-control">
                                    ...
                                    <option {{ ($product->is_featured == 'Yes') ? 'selected' : '' }} value="Yes">Iya</option>
                                </select>
                                <p class="error"></p>
                            </div>
                        </div>
