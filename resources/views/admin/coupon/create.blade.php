                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="code" id="code" class="form-control" placeholder="Kode Kupon">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Nama Kode Kupon">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="max_uses" id="max_uses" class="form-control" placeholder="Maksimal penggunaan">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Maksimal penggunaan pengguna">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="discount_amount" id="discount_amount" class="form-control" placeholder="Jumlah diskon">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="min_amount" id="min_amount" class="form-control" placeholder="Jumlah minimal">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" autocomplete="off" name="starts_at" id="starts_at" class="form-control" placeholder="Dimulai dari">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="slug">Deskripsi</label>
                                <textarea class="form-control" name="description" id="description" cols="30" rows="5"></textarea>                                <p></p>
                            </div>
                        </div>
                    </div>
                </div>
