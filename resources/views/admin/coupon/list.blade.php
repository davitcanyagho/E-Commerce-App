    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('coupons.create') }}" class="btn btn-primary">Tambah Kupon</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (!empty($discountCoupon->starts_at)) ? Carbon::parse($discountCoupon->starts_at)->format('Y/m/d H:i:s') : '' }}</td>
                                    <td>{{ (!empty($discountCoupon->expires_at)) ? Carbon::parse($discountCoupon->expires_at)->format('Y/m/d H:i:s') : '' }}</td>
