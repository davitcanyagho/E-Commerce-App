                                ...
                                <div class="card-body bg-light mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-3">
                                            ...
                                            <!-- Text -->
                                            <p class="mb-0 fs-sm fw-bold">
                                            Rp.{{ NumberFormat($order->grand_total) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="mb-4 fs-sm fw-bold">
                                                ...
                                                <span class="text-muted">Rp.{{ NumberFormat($item->price) }}</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>    
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                <li class="list-group-item d-flex">
                                    <span>Subtotal</span>
                                    <span class="ms-auto">Rp.{{ NumberFormat($order->subtotal) }}</span>
                                </li>
                                <li class="list-group-item d-flex">
                                    <span>Diskon {{ (!empty($order->coupon_code)) ? '('.$order->coupon_code.')' : ''}}</span>
                                    <span class="ms-auto">Rp.{{ NumberFormat($order->discount) }}</span>
                                </li>
                                <li class="list-group-item d-flex">
                                    <span>Ongkir</span>
                                    <span class="ms-auto">Rp.{{ NumberFormat($order->shipping) }}</span>
                                </li>
                                <li class="list-group-item d-flex fs-lg fw-bold">
                                    <span>Total</span>
                                    <span class="ms-auto">Rp.{{ NumberFormat($order->grand_total) }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
